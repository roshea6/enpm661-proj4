...
mtc::Task MTCTaskNode::createTask()
{
  ...
  const auto& hand_group_name = "end_eff"; // Does this need to be a link name or the name of the end effector
  ...
  {
    auto grasp = std::make_unique<mtc::SerialContainer>("close_gripper");
